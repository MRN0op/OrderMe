...
<div
        ...
        <div
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Agent 1 (Available) -->
                <div
                    class="p-6 bg-white rounded-lg shadow-md border border-gray-200 transition-transform transform hover:scale-105 duration-300 flex flex-col items-center text-center group">
                    <h2 class="text-xl font-semibold text-gray-800">name</h2>
                    <p class="text-gray-600 mt-1">📍 New York, NY</p>
                    <div class="flex items-center mt-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6 group-hover:text-green-600 transition">
                ...
                <div
                    ...
                    <div class="flex items-center mt-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6 group-hover:text-yellow-600 transition">
                ...
                <div
                    ...
                    <div class="flex items-center mt-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6 group-hover:text-red-600 transition">
